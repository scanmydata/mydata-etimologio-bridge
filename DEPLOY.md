...
> **Ονοματοδοσία:** το ίδιο Infisical εξυπηρετεί πολλά προϊόντα, οπότε κάθε
> μυστικό αναζητείται **πρώτα με επίθεμα** `_SCANMYDATA_SUITE` και μετά σκέτο.
> Δηλαδή το `BACKUP_PASSPHRASE_SCANMYDATA_SUITE` και το `BACKUP_PASSPHRASE`
> δουλεύουν και τα δύο, με προτεραιότητα στο πρώτο. Το επίθεμα αλλάζει με
> `BACKUP_SECRET_SUFFIX`.
