...
- [`CLOUDFLARED.md`](../CLOUDFLARED.md) — πώς μπαίνει η θύρα 8080 σε υπάρχον
...
| [`apache-etimologio.conf`](apache-etimologio.conf) | Σερβίρονται μόνο `app.php`, `etimologio.php`, `healthz.php` και τα `assets/`· κόβονται μυστικά, εργαλεία, τεκμηρίωση και αρχεία βιβλιοθήκης· κεφαλίδες ασφαλείας· `/` → `/app.php` |
