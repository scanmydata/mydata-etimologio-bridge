...
def test_speakable_text_drops_icons_and_uppercase(app) -> None:
    ...
    Από την 0.4.18 κάνει και το τρίτο: γράφει τους αριθμούς **ολογράφως**, γιατί
    ο Piper τους διάβαζε όπως-όπως. Οι λεπτομέρειες στο `test_speakable.py`.
    """
    from timologio.etimologio.speech import _speakable

    assert _speakable("✅ Εκδόθηκε · ΜΑΡΚ 4000") == "εκδόθηκε μαρκ τέσσερις χιλιάδες"
    assert _speakable("   ") == ""
