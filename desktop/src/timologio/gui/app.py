...
def main(argv: list[str] | None = None) -> int:
    ...
    # Κάθε παράθυρο που θα ανοίξει (διάλογοι, μηνύματα, προεπισκόπηση
    # εκτύπωσης) παίρνει τη γραμμή τίτλου του θέματος. Χωρίς αυτό, μόνο το
    # κεντρικό παράθυρο ήταν βαμμένο και κάθε διάλογος άνοιγε με λευκή μπάρα.
    from .theme import install_title_bar_painter
