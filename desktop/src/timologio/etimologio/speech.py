...
def _speakable(text: str) -> str:
    """Καθαρό κείμενο για εκφώνηση.

    Έκανε μόνο δύο πράγματα: πέταγε τα εικονίδια και πεζοποιούσε. Και τα δύο
    χρειάζονται — τα ελληνικά κεφαλαία γράφονται χωρίς τόνο, οπότε η μηχανή δεν
    ξέρει πού πέφτει η έμφαση — αλλά **δεν αρκούν**: ο Piper διάβαζε το
    «802576637» σαν έναν τεράστιο αριθμό και το «ΑΦΜ» σαν «αφμ».

    Η πραγματική δουλειά έγινε στο :mod:`speakable`, που είναι κοινό με την PHP
    πλευρά ώστε η ίδια πρόταση να ακούγεται ίδια και στις δύο.
    """
