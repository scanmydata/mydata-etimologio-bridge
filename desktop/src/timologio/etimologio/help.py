...
MANUAL: list[tuple[str, str]] = [
    ...
    ("Από τον Πίνακα ελέγχου, το «Αντίγραφο τώρα» πακετάρει βάση και κλειδί "
     "κρυπτογράφησης σε ένα zip. Το κλειδί μπαίνει μαζί επίτηδες: χωρίς αυτό η "
     "βάση είναι θόρυβος, και ένα αντίγραφο που δεν διαβάζεται δεν είναι "
     "αντίγραφο.", "li"),
    ("Το τοπικό αρχείο δουλεύει πάντα, χωρίς δίκτυο. Η μεταφόρτωση στο Google "
     "Drive είναι επιπλέον βήμα και λέει ρητά τι λείπει αν δεν είναι ρυθμισμένη "
     "— δεν αποτυγχάνει σιωπηλά.", "li"),
]
